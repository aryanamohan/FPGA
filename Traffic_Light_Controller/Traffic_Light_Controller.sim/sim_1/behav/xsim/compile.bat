...
REM
REM Generated by Vivado on Wed Mar 11 09:39:00 +0530 2026
...
echo "xvlog --incr --relax -prj test_traffic_controller_vlog.prj"
call xvlog  --incr --relax -prj test_traffic_controller_vlog.prj -log xvlog.log
